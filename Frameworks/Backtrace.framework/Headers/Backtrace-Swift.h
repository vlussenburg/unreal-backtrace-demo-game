...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) id <BacktraceClientCustomizing, BacktraceLogging, BacktraceReporting> _Nullable shared;)
+ (id <BacktraceClientCustomizing, BacktraceLogging, BacktraceReporting> _Nullable)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(id <BacktraceClientCustomizing, BacktraceLogging, BacktraceReporting> _Nullable)value;
...
@property (nonatomic) enum RetryOder retryOrder;
...
typedef SWIFT_ENUM(NSInteger, RetryOder, closed) {
